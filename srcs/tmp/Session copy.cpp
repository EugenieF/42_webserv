...
Cookie*		Session::_findSessionCookies(std::string sessionId)
{
...
Order*		Session::_findSessionOrder(std::string sessionId)
{
	mapOfSessions::iterator		ite;
	Order*						order;
...
Cookie*	Session::lookupSessionCookies(const Cookie& requestCookies)
{
	...
	if (sessionId == "")
		...
		cookies = getSessionCookies(sessionId);
