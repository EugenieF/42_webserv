...
/*   Updated: 2022/10/04 10:30:51 by efrancon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
EpollInstance::EpollInstance(EpollInstance::listOfServers servers) : _efd(-1), _servers(servers)
{
...
{
	while (1)
	{ // Accept every connections regarding the expected events
...
void EpollInstance::_clearClients()
{
	...
	{
		_clearClient(client->first, client->second);							//******* eug
	}
}
